function updateData(info, city) {
  ...
  var card_weather_box_html = `
    ...
    <div class="clock-row clock-row-bottom">
      <span class="card-weather-location">${city} ${info.lives[0].weather} ${info.lives[0].temperature} ℃ ${info.lives[0].humidity}% ${info.lives[0].winddirection} ${info.lives[0].windpower}</span>
    </div>
    `;
  var week = [
    "星期天",
