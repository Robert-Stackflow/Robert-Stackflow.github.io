  ...
  return (function (e) {
              ...
              value: function () {
                ...
                var t = function (t) {
                    var n =
                      ...
                      e.player.template.volumeBar.clientWidth;
                    (n = Math.max(n, 0)),
                      (n = Math.min(n, 1)),
                      e.player.volume(n);
                  },
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        return (
          ...
          "list" === s.order
            ? (a += l.orderList)
            : "random" === s.order && (a += l.orderRandom),
          (a +=
    ...
    function (e, t, n) {
      ...
      function h() {
        d &&
          u &&
          ((d = !1), u.length ? (c = u.concat(c)) : (p = -1), c.length && f());
      }
      function f() {
        if (!d) {
          var e = l(h);
