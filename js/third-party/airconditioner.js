  ...
  const gr = vr.exports,
    ...
    Fr = wr(() =>
      Li(
        "img",
        {
          src: "https://npm.elemecdn.com/hexo-theme-cloudchewie@latest/source/icon/svg/07/air-conditioner.svg",
          alt: "",
        ...
        setup(t) {
          ...
          return (t, s) => (
            ...
            Ri("div", Lr, [
              Li("audio", { id: "di" }, [
                Li("source", {
                  src: "https://npm.elemecdn.com/hexo-theme-cloudchewie@latest/source/voice/di.m4a",
                  preload: "auto",
                }),
                Li("source", {
                  src: "https://npm.elemecdn.com/hexo-theme-cloudchewie@latest/source/voice/di.mp3",
                  type: "audio/mpeg",
                  preload: "auto",
                }),
              ...
              Li("audio", { id: "ac-work" }, [
                Li("source", {
                  src: "https://npm.elemecdn.com/hexo-theme-cloudchewie@latest/source/voice/ac-work.m4a",
                  preload: "auto",
                }),
                Li("source", {
                  src: "https://npm.elemecdn.com/hexo-theme-cloudchewie@latest/source/voice/ac-work.mp3",
                  type: "audio/mpeg",
                  preload: "auto",
                }),
                Ui(" 您的浏览器不支持audio标记（元素） "),
              ...
              Li("audio", { id: "air-extractor-fan" }, [
                Li("source", {
                  src: "https://npm.elemecdn.com/hexo-theme-cloudchewie@latest/source/voice/air-extractor-fan.m4a",
                  preload: "auto",
                }),
                Li("source", {
                  src: "https://npm.elemecdn.com/hexo-theme-cloudchewie@latest/source/voice/air-extractor-fan.mp3",
                  type: "audio/mpeg",
                  preload: "auto",
                }),
                Ui(" 您的浏览器不支持audio标记（元素） "),
